...
const LandownerLoginScreen: React.FC = () => {
  ...
  const onSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      await login({ email, password, userType: 'landowner' });
    } catch (e: any) {
  ...
  const handleSignup = () => {
    navigation.navigate('Signup', { userType: 'landowner' });
  };

  const handleForgotPassword = () => {
    navigation.navigate('ForgotPassword', { userType: 'landowner' });
  };
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.flex}>
        <View style={styles.container}>
          <Animated.View style={[styles.header, { opacity: fade, transform: [{ translateY: translate }] }]}>
            ...
            <Text style={styles.title}>Landowner Login</Text>
            <Text style={styles.subtitle}>Welcome back, property owner</Text>
          </Animated.View>
...
export default LandownerLoginScreen;
